...
class DeltaService {
    ...
    async onPrepare(config, capabilities) {
        ...
        let launchId = process.env.DELTA_LAUNCH_ID;
        let response;
    ...
    async before(capabilities, specs) {
        ...
        browser.addCommand('sendFileToTest', async (type, file, description) => {
            try {
                let response = await this.requests.sendFile(this.delta_test.test_history_id, type, fs.createReadStream(file), description);
                log.info(response);
            }
            catch (e) {
                log.error(e);
